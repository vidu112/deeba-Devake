...
public class History extends AppCompatActivity {
    ...
    ArrayList<Historyclass> Tasklist;
                        ...
                        try {
                            ...
                            if(status.equals("true")) {
                                ...
                                for (int i = 0; i < result.length(); i++) {
                                    ...
                                    Tasklist.add(new Historyclass(current.getString("taskOriginName"),current.getString("taskDesName"),returndate,current.getString("taskStatus"),current.getString("taskStartTime")));
                                }
    ...
    public void updatelistview(){
        Historylistadapter=new HistoryListAdapter(this,R.layout.task_adapter_view,Tasklist);
